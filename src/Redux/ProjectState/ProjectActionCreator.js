export const PROJECT_ACTION = {
    ...
    RESET_PROJECT_USER_ASSOCIATION :"RESET_PROJECT_USER_ASSOCIATION",
    REQUEST_PROJECT_USER_ASSOCIATION :"REQUEST_PROJECT_USER_ASSOCIATION",
    RESPONSE_PROJECT_USER_ASSOCIATION:"RESPONSE_PROJECT_USER_ASSOCIATION",
    ERROR_PROJECT_USER_ASSOCIATION :"ERROR_PROJECT_USER_ASSOCIATION",
  };
  ...
  export const setResetProjectUserAssociation = () => ({
    type: PROJECT_ACTION.RESET_PROJECT_USER_ASSOCIATION,
    data: undefined
  });
  
  export const requestProjectUserAssociation = (params) =>({
    type:PROJECT_ACTION.REQUEST_PROJECT_USER_ASSOCIATION,
    data: params
  })
  export const responseProjectUserAssociation = (res) => ({
    type: PROJECT_ACTION.RESPONSE_PROJECT_USER_ASSOCIATION,
    data: res
  });
  
  export const errorProjectUserAssociation = (err) => ({
    type: PROJECT_ACTION.ERROR_PROJECT_USER_ASSOCIATION,
    data: err
  });
